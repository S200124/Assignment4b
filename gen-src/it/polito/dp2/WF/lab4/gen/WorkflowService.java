 ...
 * 
 */
@WebServiceClient(name = "WorkflowService", targetNamespace = "http://pad.polito.it/Workflow", wsdlLocation = "file:/home/alessandro/Workspace/Assignment4b/wsdl/WorkflowSearchingService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName WORKFLOWSERVICE_QNAME = new QName("http://pad.polito.it/Workflow", "WorkflowService");
     ...
     * 
     * @return
     *     returns JoinWorkflow
     */
    @WebEndpoint(name = "WorkflowPort")
    public JoinWorkflow getWorkflowPort() {
        return super.getPort(new QName("http://pad.polito.it/Workflow", "WorkflowPort"), JoinWorkflow.class);
    }
     ...
     */
    @WebEndpoint(name = "WorkflowPort")
    public JoinWorkflow getWorkflowPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://pad.polito.it/Workflow", "WorkflowPort"), JoinWorkflow.class, features);
    }
